...
|
*/
$config['rest_valid_logins'] = [getenv('DEFAULT_REST_USER') => getenv('DEFAULT_REST_PASS')];
...
|
*/
$config['rest_enable_keys'] = filter_var(getenv('REST_ENABLE_KEYS'), FILTER_VALIDATE_BOOLEAN);
