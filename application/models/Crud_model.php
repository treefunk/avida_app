...
class Crud_model extends CI_model
{
  ...
  */
  ...
  public function upload($file)
  {
    ...
    $config['upload_path'] = "uploads/your_dir/"; # NOTE: Change your directory as needed
    $config['allowed_types'] = 'gif|jpg|jpeg|png'; # NOTE: Change file tyoes as needed
    $config['file_name'] = time() . $file['name']; # Set the new filename
    $this->upload->initialize($config);
